  ...
  \begin{multicols}{2}
    \scalebox{0.65}{
      \begin{tikzpicture}[scale=1]
        ...
        \node[text centered] at (0.75,2.75) {r1};
        ...
        \node[text centered] at (3.75,4.75) {r2};
        \draw (3.75,3.5) node[above]{\small divM\_3 r1 y2} ;
        ...
        \node[text centered] at (6.75,6.75) {r3};
        \draw (6.75,5.5) node[above]{\small divM\_3 r2 y3} ;
