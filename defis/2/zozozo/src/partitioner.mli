(* Module destiné à une grosse partie du préprocessing de la feuille
   ...
   Idéalement, il faudrait mettre à jour ce partitionnement quand des
   formules ont été ajoutées ou retirées de la feuille de calcul, mais
...
val compute_regions : string -> int -> int -> ((pos * is_formula content) list * regions)
